...
public class spiritual extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        datatbaseReference= FirebaseDatabase.getInstance().getReference("spiritual");
        myQuote=new MyQuote();
